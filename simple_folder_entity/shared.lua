--[[
    The second way to develop an entity is to create a directory in `entities/`. 
    ...
    The folder name defines the class of your entity (https://wiki.facepunch.com/gmod/Entity:GetClass).
]]
